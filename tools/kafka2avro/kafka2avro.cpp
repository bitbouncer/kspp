...
int main(int argc, char **argv) {
  ...
  desc.add_options()
      ...
      ("window_size", boost::program_options::value<std::string>()->default_value(get_env_and_log("WINDOW_SIZE", "1h")),
       "window_size")
...
//  LOG(INFO) << "metrics_namespace : " << metrics_namespace;
  ...
  auto source = t->create_processors<kspp::kafka_source<void, kspp::generic_avro, void, kspp::avro_serdes>>(
