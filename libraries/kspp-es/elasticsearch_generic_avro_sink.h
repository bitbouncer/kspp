...
namespace kspp {
  ...
  public:
    elasticsearch_generic_avro_sink(std::shared_ptr<cluster_config> config, std::string remote_write_url,
                                    std::string username, std::string password, size_t max_http_connection = 20)
