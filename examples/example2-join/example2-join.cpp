...
int main(int argc, char **argv) {
  ...
  auto join = builder.create_left_join<boost::uuids::uuid, int64_t, int64_t, int64_t>(stream, table, [](const boost::uuids::uuid& key, const int64_t& left, const int64_t& right, int64_t& row) {
    row = right;
  });
  
  /*
  auto join = std::make_shared<kspp::left_join<boost::uuids::uuid, int64_t, int64_t, int64_t>>(stream, table, [](const boost::uuids::uuid& key, const int64_t& left, const int64_t& right, int64_t& row) {
    row = right;
  });
  */
