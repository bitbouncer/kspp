#include <iostream>
#include <chrono>
#include <kspp/internal/serdes/avro/avro_serdes.h>
#include <kspp/internal/serdes/avro/avro_text.h>
...
#include <kspp/internal/kafka_utils.h>
...
int main(int argc, char **argv) {
  ...
  auto parsed = topology->create_processors<kspp::flat_map<void, kspp::GenericAvro, int, std::string>>(sources,
                                                                                                       [](std::shared_ptr<const kspp::krecord<void, kspp::GenericAvro>> in,
                                                                                                          auto stream) {
                                                                                                         ...
                                                                                                         if (datum->type() ==
                                                                                                           ...
                                                                                                           try {
                                                                                                             int id = get_nullable_value(
                                                                                                                 r,
                                                                                                                 "id",
                                                                                                                 -1);
                                                                                                             std::string hash = get_nullable_value(
                                                                                                                 r,
                                                                                                                 "hash",
                                                                                                                 "");

                                                                                                             flat_map->push_back(
                                                                                                                 std::make_shared<kspp::krecord<int, std::string>>(
                                                                                                                     id,
                                                                                                                     "nisse"));
                                                                                                           }
                                                                                                           catch (...) {
