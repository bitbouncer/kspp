...
namespace kspp {
  ...
  public:
    ...
    */
    ...
    template<class T>
    size_t decode(int32_t expected_schema_id, std::shared_ptr<const avro::ValidSchema> schema, const char *payload,
                  size_t size, T &dst) {
  ...
  template<>
  inline size_t avro_serdes::encode(const std::string &src, std::ostream &dst) {
    static int32_t schema_id = -1;
    std::shared_ptr<const avro::ValidSchema> not_used;
    if (schema_id > 0)
      return encode(schema_id, src, dst);
  ...
  template<>
  inline size_t avro_serdes::decode(const char *payload, size_t size, std::string &dst) {
    static int32_t schema_id = -1;
  ...
  template<>
  inline size_t avro_serdes::encode(const int64_t &src, std::ostream &dst) {
    static int32_t schema_id = -1;
    std::shared_ptr<const avro::ValidSchema> not_used;
    if (schema_id > 0)
      return encode(schema_id, src, dst);
  ...
  template<>
  inline size_t avro_serdes::decode(const char *payload, size_t size, int64_t &dst) {
    static int32_t schema_id = -1;
    static std::shared_ptr<const avro::ValidSchema> valid_schema; // this means we never free memory from used schemas???
    if (schema_id > 0)
      return decode(schema_id, valid_schema, payload, size, dst);
  ...
  template<>
  inline size_t avro_serdes::encode(const int32_t &src, std::ostream &dst) {
    static int32_t schema_id = -1;
    std::shared_ptr<const avro::ValidSchema> not_used;
    if (schema_id > 0)
      return encode(schema_id, src, dst);
  ...
  template<>
  inline size_t avro_serdes::decode(const char *payload, size_t size, int32_t &dst) {
    static int32_t schema_id = -1;
    static std::shared_ptr<const avro::ValidSchema> valid_schema; // this means we never free memory from used schemas???
    if (schema_id > 0)
      return decode(schema_id, valid_schema, payload, size, dst);
  ...
  template<>
  inline size_t avro_serdes::encode(const bool &src, std::ostream &dst) {
    static int32_t schema_id = -1;
    std::shared_ptr<const avro::ValidSchema> not_used;
    if (schema_id > 0)
      return encode(schema_id, src, dst);
  ...
  template<>
  inline size_t avro_serdes::decode(const char *payload, size_t size, bool &dst) {
    static int32_t schema_id = -1;
    static std::shared_ptr<const avro::ValidSchema> valid_schema; // this means we never free memory from used schemas???
    if (schema_id > 0)
      return decode(schema_id, valid_schema, payload, size, dst);
  ...
  template<>
  inline size_t avro_serdes::encode(const float &src, std::ostream &dst) {
    static int32_t schema_id = -1;
    std::shared_ptr<const avro::ValidSchema> not_used;
    if (schema_id > 0)
      return encode(schema_id, src, dst);
  ...
  template<>
  inline size_t avro_serdes::decode(const char *payload, size_t size, float &dst) {
    static int32_t schema_id = -1;
    static std::shared_ptr<const avro::ValidSchema> valid_schema; // this means we never free memory from used schemas???
    if (schema_id > 0)
      return decode(schema_id, valid_schema, payload, size, dst);
  ...
  template<>
  inline size_t avro_serdes::encode(const double &src, std::ostream &dst) {
    static int32_t schema_id = -1;
    std::shared_ptr<const avro::ValidSchema> not_used;
    if (schema_id > 0)
      return encode(schema_id, src, dst);
  ...
  template<>
  inline size_t avro_serdes::decode(const char *payload, size_t size, double &dst) {
    static int32_t schema_id = -1;
    static std::shared_ptr<const avro::ValidSchema> valid_schema; // this means we never free memory from used schemas???
    if (schema_id > 0)
      return decode(schema_id, valid_schema, payload, size, dst);
  ...
  template<>
  inline size_t avro_serdes::encode(const std::vector<uint8_t> &src, std::ostream &dst) {
    static int32_t schema_id = -1;
    std::shared_ptr<const avro::ValidSchema> not_used;
    if (schema_id > 0)
      return encode(schema_id, src, dst);
  ...
  template<>
  inline size_t avro_serdes::decode(const char *payload, size_t size, std::vector<uint8_t> &dst) {
    static int32_t schema_id = -1;
    static std::shared_ptr<const avro::ValidSchema> valid_schema; // this means we never free memory from used schemas???
    if (schema_id > 0)
      return decode(schema_id, valid_schema, payload, size, dst);
  ...
  template<>
  inline size_t avro_serdes::encode(const boost::uuids::uuid &src, std::ostream &dst) {
    static int32_t schema_id = -1;
    std::shared_ptr<const avro::ValidSchema> not_used;
    if (schema_id > 0)
  ...
  template<>
  inline size_t avro_serdes::decode(const char *payload, size_t size, boost::uuids::uuid &dst) {
    static int32_t schema_id = -1;
    static std::shared_ptr<const avro::ValidSchema> valid_schema; // this means we never free memory from used schemas???
  ...
  template<>
  inline size_t avro_serdes::decode(const char *payload, size_t size, kspp::generic_avro &dst) {
    if (size < 5 || payload[0])
      return 0;
  ...
  template<>
  inline size_t avro_serdes::encode(const kspp::generic_avro &src, std::ostream &dst) {
