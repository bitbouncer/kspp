...
namespace kspp {
  ...
  public:
    generic_avro_sink(std::shared_ptr<cluster_config> config,
                      std::shared_ptr<generic_producer<kspp::generic_avro, kspp::generic_avro>> impl)
        : impl_(impl) {
    }
  ...
  protected:
    //bool exit_= false;
    std::shared_ptr<generic_producer<kspp::generic_avro, kspp::generic_avro>> impl_;
  };
}
