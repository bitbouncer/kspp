...
sed -i.bak2 '/regex system)/a SET(Boost_LIBRARIES Boost::program_options Boost::iostreams Boost::filesystem Boost::regex Boost::system z bz2)' avro/lang/c++/CMakeLists.txt
